        ...
        <table className="table">
          ...
          <thead>
            <tr>
              <th></th>
              <th></th>
              <th className="text-lg font-semibold  text-black">Class Name</th>
              <th className="text-lg font-semibold  text-black">Instructor</th>
              <th className="text-lg font-semibold  text-black">Class Price</th>
